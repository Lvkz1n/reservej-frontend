...
export function EmpresaLayout() {
  ...
  const getRoleLabel = () => {
    switch (user?.role) {
      case 'empresa-admin': return 'Administrador';
      case 'empresa-atendente': return 'Atendente';
      case 'empresa-profissional': return 'Profissional';
      case 'empresa-leitura': return 'Leitura';
